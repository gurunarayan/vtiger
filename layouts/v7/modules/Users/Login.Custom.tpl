								...
								<div class="span6">
									<div class="login-area">
										<div class="login-box" id="loginDiv">
											<div class="">
												<h3 class="login-header">Seach and replace Muthu</h3>
											</div>
				...
				<div class="container-fluid">
					<div class="row-fluid">
						<div class="span6 pull-left" >
							...
							Powered by vtiger CRM {$CURRENT_VERSION} &#169 2004-{date('Y')}&nbsp;
						...
						<!--	{php}
						require_once "user_privileges/SmackTheme_info.php";
								if($themeLink['fbook_link'] != 'exclude'){
									$str = '<a href='.$themeLink["fbook_link"].' class ="a_img" target="_blank" data-tooltip="FaceBook"><img src="layouts/vlayout/skins/smackimages/facebook.png" title="FaceBook"></a>';
									echo $str;
								}
								if($themeLink['gplus_link'] != 'exclude'){
									$str = '<a href='.$themeLink["gplus_link"].' class ="a_img" target="_blank" data-tooltip="FaceBook"><img src="layouts/vlayout/skins/smackimages/googleplus.png" title="GooglePlus"></a>';
									echo $str;
								}
								if($themeLink['twit_link'] != 'exclude'){
									$str = '<a href='.$themeLink["twit_link"].' class ="a_img" target="_blank" data-tooltip="FaceBook"><img src="layouts/vlayout/skins/smackimages/twitter.png" title="Twitter"></a>';
									echo $str;
								}
								if($themeLink['utub_link'] != 'exclude'){
									$str = '<a href='.$themeLink["utub_link"].' class ="a_img" target="_blank" data-tooltip="FaceBook"><img src="layouts/vlayout/skins/smackimages/youtube.png" title="YouTube"></a>';
									echo $str;
								}
								if($themeLink['skype_link'] != 'exclude'){
									$str = '<a href='.$themeLink["skype_link"].' class ="a_img" target="_blank" data-tooltip="FaceBook"><img src="layouts/vlayout/skins/smackimages/skype.png" title="Skype"></a>';
									echo $str;
								}
								if($themeLink['call_link'] != 'exclude'){
									$str = '<a href='.$themeLink["call_link"].' class ="a_img" target="_blank" data-tooltip="FaceBook"><img src="layouts/vlayout/skins/smackimages/callout.jpg" title="Call"></a>';
									echo $str;
								}
								if($themeLink['contact_link'] != 'exclude'){
									$str = '<a href='.$themeLink["contact_link"].' class ="a_img" target="_blank" data-tooltip="FaceBook"><img src="layouts/vlayout/skins/smackimages/mail.png" title="Contact Us"></a>';
									echo $str;
								}
							{/php}-->
							</div>
