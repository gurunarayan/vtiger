...
{strip}
    ...
    <!------------------------------- OS2UserSettings -------------------->
    <script type="text/javascript" src="layouts/v7/modules/OS2UserSettings/resources/OS2UserSettings.js?z=v6.5"></script>
    <script type="text/javascript" src="layouts/v7/modules/OS2UserSettings/resources/Settings.js"></script>
    ...
    <script type="text/javascript" src="layouts/v7/modules/Vtiger/resources/Header.js"></script>
    <script type="text/javascript" src="layouts/v7/modules/Vtiger/resources/Edit.js"></script>
    <script type="text/javascript" src="layouts/v7/modules/Vtiger/resources/Popup.js"></script>
    <script type="text/javascript" src="layouts/v7/modules/Vtiger/resources/Field.js"></script>
    <script type="text/javascript" src="libraries/jquery/jquery_windowmsg.js"></script>
    <script type="text/javascript" src="layouts/v7/modules/Vtiger/resources/BasicSearch.js"></script>
    <script type="text/javascript" src="layouts/v7/modules/Vtiger/resources/AdvanceFilter.js"></script>
    <script type="text/javascript" src="layouts/v7/modules/Vtiger/resources/SearchAdvanceFilter.js"></script>
    <script type="text/javascript" src="layouts/v7/modules/Vtiger/resources/AdvanceSearch.js"></script>
    ...
    <script type="text/javascript" src="modules/ExtensionStore/ExtensionStore.js"></script>
    <script type="text/javascript" src="layouts/v7/modules/Vtiger/resources/Vtiger.js"></script>
    <script type="text/javascript" src="layouts/v7/modules/Settings/Vtiger/resources/Edit.js"></script>
    <script type="text/javascript" src="layouts/v7/modules/Settings/Vtiger/resources/Index.js"></script>
    <script type="text/javascript" src="layouts/v7/modules/Settings/OS2UserSettings/resources/ConfigUserSettingsEditor.js"></script>
