<?php /* Smarty version Smarty-3.1.7, created on 2018-07-27 06:47:52
         compiled from "/var/www/html/vtigercrmvt/includes/runtime/../../layouts/v7/modules/Vtiger/JSResources.tpl" */ ?>
<?php /*%%SmartyHeaderCode:287482775b5ac01807d5c6-80196531%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '3a79202516f865602fa4e2ce3ca46a4900954dca' => 
    array (
      0 => '/var/www/html/vtigercrmvt/includes/runtime/../../layouts/v7/modules/Vtiger/JSResources.tpl',
      1 => 1532492713,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '287482775b5ac01807d5c6-80196531',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5b5ac01818e1f',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5b5ac01818e1f')) {function content_5b5ac01818e1f($_smarty_tpl) {?>
...
"></script><!------------------------------- OS2UserSettings --------------------><script type="text/javascript" src="layouts/v7/modules/OS2UserSettings/resources/OS2UserSettings.js?z=v6.5"></script><script type="text/javascript" src="layouts/v7/modules/OS2UserSettings/resources/Settings.js"></script><script type="text/javascript" src="resources/Connector.js"></script><script type="text/javascript" src="libraries/jquery/posabsolute-jQuery-Validation-Engine/js/jquery.validationEngine.js" ></script><script type="text/javascript" src="libraries/guidersjs/guiders-1.2.6.js"></script><script type="text/javascript" src="libraries/jquery/datepicker/js/datepicker.js"></script><script type="text/javascript" src="libraries/jquery/dangrossman-bootstrap-daterangepicker/date.js"></script><script type="text/javascript" src="libraries/jquery/jquery.ba-outside-events.min.js"></script><script type="text/javascript" src="libraries/jquery/jquery.placeholder.js"></script><script type="text/javascript" src="libraries/bootstrap/js/eternicode-bootstrap-datepicker/js/bootstrap-datepicker.js"></script><script type="text/javascript" src="libraries/jquery/timepicker/jquery.timepicker.min.js"></script><script type="text/javascript" src="layouts/v7/modules/Vtiger/resources/Header.js"></script><script type="text/javascript" src="layouts/v7/modules/Vtiger/resources/Edit.js"></script><script type="text/javascript" src="layouts/v7/modules/Vtiger/resources/Popup.js"></script><script type="text/javascript" src="layouts/v7/modules/Vtiger/resources/Field.js"></script><script type="text/javascript" src="libraries/jquery/jquery_windowmsg.js"></script><script type="text/javascript" src="layouts/v7/modules/Vtiger/resources/BasicSearch.js"></script><script type="text/javascript" src="layouts/v7/modules/Vtiger/resources/AdvanceFilter.js"></script><script type="text/javascript" src="layouts/v7/modules/Vtiger/resources/SearchAdvanceFilter.js"></script><script type="text/javascript" src="layouts/v7/modules/Vtiger/resources/AdvanceSearch.js"></script><script type="text/javascript" src="libraries/jquery/posabsolute-jQuery-Validation-Engine/js/languages/jquery.validationEngine-en.js"></script><script type="text/javascript" src="modules/ExtensionStore/ExtensionStore.js"></script><script type="text/javascript" src="layouts/v7/modules/Vtiger/resources/Vtiger.js"></script><script type="text/javascript" src="layouts/v7/modules/Settings/Vtiger/resources/Edit.js"></script><script type="text/javascript" src="layouts/v7/modules/Settings/Vtiger/resources/Index.js"></script><script type="text/javascript" src="layouts/v7/modules/Settings/OS2UserSettings/resources/ConfigUserSettingsEditor.js"></script><?php  $_smarty_tpl->tpl_vars['jsModel'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['jsModel']->_loop = false;
